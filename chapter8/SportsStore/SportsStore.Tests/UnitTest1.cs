...
namespace SportsStore.Tests
{
    ...
    {
        private Tuple<ProductsListViewModel, ProductController> paginate_setup()
        {
            //Arrange
           ...
           return Tuple.Create(result, controller);
        }
        ...
        public void Can_Paginate()
        {
            ...
            ProductController controller = setup.Item2;
        ...
        public void Can_Generate_Page_Links()
        {
            ...
            //Act 
            MvcHtmlString result = (MvcHtmlString)myHelper.PageLinks(paginginfo, pageUrlDelegate);
            //Assert
